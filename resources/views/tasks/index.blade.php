        ...
        <div class="row mb-4 animate__animated animate__fadeInUp">
            ...
            <div class="col-md-3 mb-3">
                <div class="stats-card">
                    <div class="d-flex align-items-center justify-content-between">
                        <div>
                            <div class="stats-number text-warning">{{ $activeTasks }}</div>
            ...
            <div class="col-md-3 mb-3">
                <div class="stats-card">
                    <div class="d-flex align-items-center justify-content-between">
                        <div>
                            <div class="stats-number text-info">{{ $completionRate }}%</div>
                        ...
                        <div class="progress-ring">
                            <svg class="progress-ring" width="60" height="60">
                                <circle class="progress-ring-circle" 
                                        cx="30" cy="30" r="30" 
                                        style="stroke-dashoffset: {{ 188.5 - (188.5 * $completionRate / 100) }}">
                                </circle>
                            </svg>
                        </div>
                    </div>
                ...
                <div class="col-md-4">
                    ...
                    <select name="due" id="due" class="form-select" onchange="this.form.submit()">
                        ...
                        <option value="today" {{ request('due') == 'today' ? 'selected' : '' }}>
                            <i class="bi bi-calendar-day"></i> Due Today ({{ $dueTodayTasks }})
                        </option>
                    </select>
                </div>
                ...
                <form action="{{ route('tasks.store') }}" method="POST" class="row g-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="date" class="form-control" id="due_date" name="due_date" 
                               value="{{ old('due_date') }}" min="{{ today()->format('Y-m-d') }}">
                    </div>
                                    ...
                                    <tr class="task-row animate__animated animate__fadeInLeft" 
                                        ...
                                        <td class="text-center">
                                            @if($task->due_date)
                                                ...
                                                @endphp
                                                <span class="badge {{ $isOverdue ? 'bg-danger' : ($isDueToday ? 'bg-warning text-dark' : ($isDueSoon ? 'bg-info' : 'bg-secondary')) }}">
                                                    @if($isOverdue)
